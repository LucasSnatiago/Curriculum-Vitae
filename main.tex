...
\mynames{Lucas Santiago de Oliveira}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Lucas Santiago de Oliveira}

  \makefield{\faEnvelope[regular]}
  {\href{mailto:lu.santi.oliveira@gmail.com}{\texttt{lu.santi.oliveira@gmail.com}}}
  ...
  {\href{https://www.linkedin.com/in/lucassnatiago/}{\texttt{lucassnatiago}}}

  \makefield{\faGithub}
  {\href{https://github.com/LucasSnatiago}{\texttt{LucasSnatiago}}}
...
\textbf{Aviso:} Este documento possui muitos hiperlinks para páginas externas embutidos, leia passando o \emph{mouse} por cima dos textos.
Caso não esteja vendo os links ou esteja visualizando em um documento impresso, favor visitar: \href{https://github.com/LucasSnatiago/Curriculum-Vitae}{https://github.com/LucasSnatiago/Curriculum-Vitae}
e baixar a versão mais atualizada desse documento na aba Releases.
